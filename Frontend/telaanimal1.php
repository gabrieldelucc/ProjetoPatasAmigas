...
<body>
    ...
    <main>
        <div class="container">
            <!-- Imagem do Pet -->
            <div class="pet-image">
                <img src="https://krcrtv.com/resources/media/648003d0-02df-477b-890f-f816512869c7-large1x1_thumbnail_IMG_0399.jpg" alt="Yorkshire terrier">
            </div>

            <!-- Detalhes do Pet -->
            <div class="pet-details">
                <h1>Berlin</h1>
                <h2>Cachorro | Macho | Adulto | Porte Pequeno</h2>
                ...
                <div class="description">
                    <h3>Descrição</h3>
                    <p>
                        Um energetico cachorro que vai ganhar seu coração, tem 4 anos e uma saúde perfeita </p>
                </div>
